...
import { DISTRIBUTOR_TIERS, B2B2C_SEGMENTS, B2B2C_API_TIERS, SLA_PLANS, COSTO_IDC_REF } from "../data/channels";
import { PRECIO_CERT_JURIDICA } from "../data/volumeTiers";
